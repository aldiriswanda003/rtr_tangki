...
{
    protected $_ci;
    protected $email_pengirim = 'aldiriswanfa233@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Aldi Admin RTR'; // Isikan dengan nama pengirim
    protected $password = 'pgfkfdfhhhqoufbe'; // Isikan dengan password email pengirim
    //bukan yg itu ada di googlenya

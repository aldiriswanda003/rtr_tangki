...
class Koor extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Home';
        $this->load->view('koor/index', $data);
    ...
    public function tambah_seri_ban()
    {
        ...
        $this->load->view('koor/form_seri_ban/tambah_seri', $data);
    }
    ...
    public function proses_tambah_seri()
    {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            $this->session->set_flashdata('msg_sukses', 'Data Berhasil Di Tambahkan');
            redirect(base_url('koor/tabel_seri_ban'));
        } else {
            $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
    ...
    public function edit_seri()
    {
        ...
        $this->load->view('koor/form_seri_ban/edit_seri', $data);
    }
    ...
    public function tabel_supir_tangki()
    {
        ...
        $this->load->view('koor/form_supir_tangki/supir_tangki', $data);
    }
    ...
    public function tambah_supir_tangki()
    {
        ...
        $this->load->view('koor/form_supir_tangki/tambah_supir_tangki', $data);
    }
    ...
    public function proses_tambah_supir_tangki()
    {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            $this->session->set_flashdata('msg_sukses', 'Data Berhasil Di Tambahkan');
            redirect(base_url('koor/tabel_supir_tangki'));
        } else {
            $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
            $data['title'] = 'Tambah Data Supir & Tangki ';
            $this->load->view('koor/form_seri_ban/tambah_supir_tangki', $data);
        }
    }
    ...
    public function edit_supir_tangki()
    {
        ...
        $this->load->view('koor/form_supir_tangki/edit_supir_tangki', $data);
    }
    ...
    public function tabel_service_masuk()
    {
        ...
        $this->load->view('koor/form_service_masuk/service_masuk', $data);
    }
    ...
    public function tambah_service_masuk()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Tambah Supir Tangki';
        $this->load->view('koor/form_service_masuk/tambah_service_masuk', $data);
    }
    ...
    public function proses_tambah_service_masuk()
    {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            $this->session->set_flashdata('msg_sukses', 'Data Berhasil Di Tambahkan');
            redirect(base_url('koor/tabel_service_masuk'));
        } else {
            $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
    ...
    public function edit_service_masuk()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Edit Supir Tangki';
        $this->load->view('koor/form_service_masuk/edit_service_masuk', $data);
    }
    ...
    public function info_service_unit()
    {
        ...
        $this->load->view('koor/form_service_masuk/info_service_unit', $data);
    }
    ...
    {
        $data['exp_surat'] = $this->M_admin->ambil_exp_surat('tb_exp_surat');
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));

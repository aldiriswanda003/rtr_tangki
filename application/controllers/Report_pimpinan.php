...
class Report_pimpinan extends CI_Controller
{
    ...
    public function tabel_rep_tangki()
    {
        ...
        $this->load->view('pimpinan/report/tangki/tampilan_rep_tangki', $data);
    }
    ...
    public function cetak_print_tangki()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Data Tangki';
        $this->load->view('pimpinan/report/tangki/print_tangki', $data);
    }
    ...
    public function cetak_detail_tangki()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Data Tangki';
        $this->load->view('pimpinan/report/tangki/print_detail_tangki', $data);
    }
    ...
    public function control_detail_tangki()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Data Tangki';
        $this->load->view('pimpinan/report/tangki/detail_tangki', $data);
    }
    ...
    public function tabel_rep_supir_tangki()
    {
        ...
        $this->load->view('pimpinan/report/supir_tangki/tampilan_supir_tangki', $data);
    }
    ...
    public function cetak_rep_supir_tangki()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Supir Tangki';
        $this->load->view('pimpinan/report/supir_tangki/print_supir_tangki', $data);
    }
    ...
    public function tabel_rep_supir()
    {
        ...
        $this->load->view('pimpinan/report/supir/tampilan_rep_supir', $data);
    ...
    public function cetak_rep_supir()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Data Supir';
        $this->load->view('pimpinan/report/supir/print_rep_supir', $data);
    }
    ...
    public function info_rep_supir()
    {
        ...
        $this->load->view('pimpinan/report/supir/info_supir', $data);
    }
    ...
    public function tabel_rep_seri_ban()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Seri Ban';
        $this->load->view('pimpinan/report/form_seri_ban/tampilan_rep_seri_ban', $data);
    }
    ...
    public function cetak_seri_ban()
    {
        ...
        $data['avatar'] = $this->M_admin->get_data_avatar('tb_user', $this->session->userdata('name'));
        $data['title'] = 'Seri Ban';
        $this->load->view('pimpinan/report/form_seri_ban/print_seri_ban', $data);
    }
}

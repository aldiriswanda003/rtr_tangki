                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('report/cetak_rep_supir'); ?>" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-success" name="tambah_data"><i class="fa fa-print mr-2" aria-hidden="true"></i>Cetak</a>
                                    ...
                                    if (is_array($supir)) { ?>
                                        <?php foreach ($supir as $sp) : ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('report/info_rep_supir/' . $sp->id_supir); ?>" type="button" class="btn btn-xs btn-warning " name=""><i class="fa fa-circle-info"></i>&nbsp;DETAIL</a></td>

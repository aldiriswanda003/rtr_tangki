                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <!-- <a href="<?= base_url('koor/tambah_supir_tangki'); ?>" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-primary" name="tambah_supir_tangki"><i class="fa fa-plus mr-2" aria-hidden="true"></i>Tambah</a> -->
                            <a href="<?= base_url('report/cetak_rep_supir_tangki'); ?>" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-success" name="cetak_data"><i class="fa fa-print mr-2" aria-hidden="true"></i>Cetak</a>
                                    ...
                                    if (is_array($supir_tangki)) { ?>
                                        <?php foreach ($supir_tangki as $st) : ?>
                                            <tr>
                                                ...
                                                <!-- <td><a href="<?= base_url('koor/edit_supir_tangki/' . $st->id_supir_tangki); ?>" type="button" class="btn btn-sm btn-success" name="btn_edit"><i class="fa fa-edit"></i>&nbsp;Edit</a></td> -->
                                                <!-- <td><a href="<?= base_url('koor/hapus_supir_tangki/' . $st->id_supir_tangki); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash"></i>&nbsp;Hapus</a></td> -->

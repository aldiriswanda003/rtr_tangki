                                    ...
                                    if (is_array($supir_tangki)) { ?>
                                        <?php foreach ($supir_tangki as $st) : ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('koor/edit_supir_tangki/' . $st->id_supir_tangki); ?>" type="button" class="btn btn-sm btn-success" name="btn_edit"><i class="fa fa-edit"></i>&nbsp;Edit</a> &nbsp;
                                             <a href="<?= base_url('koor/hapus_supir_tangki/' . $st->id_supir_tangki); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash"></i>&nbsp;Hapus</a></td>

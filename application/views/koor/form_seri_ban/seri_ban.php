                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <a href="<?= base_url('koor/tambah_seri_ban'); ?>" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-primary" name="tambah_seri"><i class="fa fa-plus mr-2" aria-hidden="true"></i>Tambah</a>
                                    ...
                                    if (is_array($seri_ban)) { ?>
                                        <?php foreach ($seri_ban as $sb) : ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('koor/edit_seri/' . $sb->id_seri_ban); ?>" type="button" class="btn btn-sm btn-success" name="btn_edit"><i class="fa fa-edit"></i>&nbsp;</a>
                                                <a href="<?= base_url('koor/hapus_seri/' . $sb->id_seri_ban); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash"></i>&nbsp;</a></td>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?= site_url('koor/tabel_seri_ban'); ?>" method="get" role="form">

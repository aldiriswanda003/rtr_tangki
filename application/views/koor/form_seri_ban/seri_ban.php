                                    ...
                                    if (is_array($seri_ban)) { ?>
                                        <?php foreach ($seri_ban as $sb) : ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('koor/edit_seri/' . $sb->id_seri_ban); ?>" type="button" class="btn btn-sm btn-success" name="btn_edit"><i class="fa fa-edit"></i>&nbsp;Edit</a></td>
                                                <td><a href="<?= base_url('koor/hapus_seri/' . $sb->id_seri_ban); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete"><i class="fa fa-trash"></i>&nbsp;Hapus</a></td>

                    ...
                    <div class="card" style="margin-left: 11%;">
                        ...
                        <div class="card-body card-profile" align="center">
                            <div class="info">
                                ...
                                Anda Login <strong><?= $this->session->userdata('name') ?></strong> sebagai kooristrator
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                <!-- <div class="tab-pane fade" id="picture" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                    <form class="form-horizontal" action="<?= base_url('koor/proses_gambarupload'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group " align="center">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <a href="<?= base_url('koor'); ?>" type="button" class="btn btn-sm btn-default" onclick="" name="btn_kembali"><i class="fa fa-arrow-left mr-2"></i>Kembali</a>
                                ...
                                <div class="tab-pane fade show active" id="settings" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                    <form class="form-horizontal" action="<?= base_url('koor/proses_newpassword'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php } ?>
                                        <form class="form-horizontal" action="<?= base_url('koor/proses_newpassword'); ?>" method="post">
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group" align="center">
                                                <div class=" col-sm-10">
                                                    <a href="<?= base_url('koor'); ?>" type="button" class="btn btn-sm btn-danger" onclick="" name="btn_kembali"><i class="fa fa-arrow-left mr-2"></i>Batal</a>
                                                    <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-check mr-2"></i>Simpan</button>
                                                </div>
                                            </div>
                                        </form>
                                        <!-- <a href="<?= base_url('koor/users'); ?>" type="button" class="btn btn-sm btn-secondary" onclick="" name="btn_kembali"><i class="fa fa-arrow-left mr-2"></i>Kembali</a> -->
                                </div>
                                </form>
                            </div>

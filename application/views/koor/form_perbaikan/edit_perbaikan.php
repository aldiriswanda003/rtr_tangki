            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('koor/tabel_perbaikan'); ?>">Data Perbaikan</a></li>
                ...
                <div class="col-md-12">
                    <div class="card" style="width: 30%; margin-left: 35%;">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('koor/proses_edit_perbaikan'); ?>" method="post" role="form" enctype="multipart/form-data">

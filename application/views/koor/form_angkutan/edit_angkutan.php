                ...
                <div class="col-md-12">
                    <div class="card" style="width: 30%; margin-left: 35%;">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('koor/proses_edit_angkutan'); ?>" method="post" role="form" enctype="multipart/form-data">
...
<br>
                                        ...
                                        <div class="form-group " align="center">
                                            <a href="<?= base_url('koor/tabel_bengkel'); ?>" type="button" class="btn btn-sm btn-danger" name="btn_kembali"><i class="fa fa-arrow-left mr-2"></i>Batal</a>

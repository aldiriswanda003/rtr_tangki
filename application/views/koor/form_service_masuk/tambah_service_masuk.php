            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('koor/tabel_service_masuk'); ?>">Data Surat Tangki</a></li>
                ...
                <div class="col-md-12">
                    <div class="card" style="width: 70%; margin-left: 20%;">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('koor/proses_tambah_service_masuk'); ?>" method="post" role="form" enctype="multipart/form-data">

...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/tabel_pengeluaran'); ?>">Data Bengkel</a></li>
                        <li class="breadcrumb-item active">Tambahkan Data Pengeluaran Lain-lain</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card" style="width: 100%; margin-left: 35%;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_pengeluaran" class="form-control" id="nama_pengeluaran" placeholder="Tuliskan keterangan" required>
                                </div>

                                <div class="form-group">
                                    <label for="biaya_pengeluaran" class="form-label">Biaya</label>
                                    <input type="text"  name="biaya_pengeluaran" class="form-control" id="" placeholder="Masukkan Biaya Pengeluaran" required >
                                    <!-- <input type="text"  name="biaya_pengeluaran" class="form-control" id="dengan-rupiah" placeholder="Masukkan Biaya Pengeluaran" required> -->
                                </div> 

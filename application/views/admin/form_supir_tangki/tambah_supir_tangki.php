...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah data tangki</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin'); ?>">Home</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/tabel_supir_tangki'); ?>">Data Supitr Tangki</a></li>
                        <li class="breadcrumb-item active">isi Data Supir dan Tangki yang dipegang</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card" style="width: 30%; margin-left: 35%;">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/proses_tambah_supir_tangki'); ?>" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="id_supir" class="form-control" id="id_supir">
                                        <option value="" selected>-- Pilih nama supir --</option>
                                        <?php foreach ($list_supir as $s) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_update" class="form-control" id="tanggal_update" placeholder="Masukkan Tanggal Update memakai tangki" required>
                
                                
                                <hr>
                                <div class="form-group" align="center">
                                    <a href="<?= base_url('admin/tabel_supir_tangki'); ?>" type="button" class="btn btn-sm btn-danger" name="btn_kembali"><i class="fa fa-arrow-left mr-2"></i>Batal</a>

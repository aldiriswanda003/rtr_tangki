                ...
                <div class="col-md-5 ">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/kirim_email_surat'); ?>" method="post" role="form" enctype="multipart/form-data">
                                ...
                                <div style="margin-bottom: 10px;">
                                    ...
                                    <input type="text" name="subjek" placeholder="Subjek" style="margin-top: 5px;width: 400px" value="PERINGATAN SURAT MATI"/>
                                </div>
                                <div style="margin-bottom: 10px;">
                                <?php foreach ($notifOut as $c) : ?>
                                    <label>Pesan</label><br />
       
                                    <textarea name="pesan" placeholder="Pesan" rows="8" style="margin-top: 5px;width: 400px">Peringatan <?= $c-> nopol ?> dengan Jenis Surat : <?= $c->jenis_surat; ?>
                                    Mati Tanggal <?= date('d/M/Y', strtotime($c->tanggal_expired)); ?>
                                </textarea>         
                                </div>

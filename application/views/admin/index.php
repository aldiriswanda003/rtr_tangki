            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-blue">
                        ...
                        <a href="<?= base_url(); ?>admin/tabel_supir" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-blue">
                        ...
                        <a href="admin/tabel_tangki" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <!-- <div class="small-box bg-red">
                    ...
                    <a href="admin/tabel_pengeluaran" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div> -->
                <!-- </div> -->
                ...
                <div class="icon">
                    ...
                    <i class="fas"> <img src="assets/upload/surat_tangki.png" alt="" width="90px"></i>

            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/tabel_perbaikan'); ?>">Data Surat Tangki</a></li>
                ...
                <div class="col-md-12">
                    <div class="card" style="width: 70%; margin-left: 20%;">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/proses_tambah_perbaikan'); ?>" method="post" role="form" enctype="multipart/form-data">

...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0">SURAT-SURAT DATA KENDARAAN TRUK TANGKI</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= base_url('admin/tambah_surat'); ?>" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-primary" name="tambah_data"><i class="fa fa-plus mr-2" aria-hidden="true"></i>Tambah</a>
                                    ...
                                    if (is_array($surat_tangki)) { ?>
                                        <?php foreach ($surat_tangki as $st) : ?>
                                            <tr>
                                                ...
                                                <?php if ($st->status == 0) { ?>
                                                    <td><a href="#" type="button" class="btn btn-success btn-xs" >  BELUM MATI</a></td>

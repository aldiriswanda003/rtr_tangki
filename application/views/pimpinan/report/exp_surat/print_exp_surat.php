...
$pdf->SetTitle('Laporan Exp Surat');
...
$html =
    ...
    '<div>
       <h1 align="center">Pengajuan Perpanjangan masa berlaku surat-surat</h1>
       ...
       <table cellspacing="1" cellpadding="2"  border="1" >
        ...
        <tr bgcolor=" #d1d1d1 ">
         ...
         <th  align="center"> Perkiraan Biaya</th>
         </tr>';

$no = 1;

    foreach ($exp_surat as $d) :
        $html .= '<tr>
...
if($d->status == 0) {
 $html .=       '<td >BELUM MATI</td>';
} else {
    $html .='<td>SUDAH MATI</td>';
}
    

$html .= '<td>Rp ' . number_format($d->perkiraan_biaya) . '</td>';
...
foreach ($total_data as $td) :
    $html .=
        '<tr>
                                            ...
                                            <th ><b><span style="color: red;">Rp&nbsp;' . number_format($td->perkiraan_biaya) . '</span></b></th>
                                            </tr>';
endforeach;

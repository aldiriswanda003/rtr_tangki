                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <form action="<?= site_url('report_pimpinan/cetak_rep_pengeluaran'); ?>" method="post" role="form">
                                ...
                                <button data-toggle="modal" data-target="#staticKeluarBulanan" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-warning " name="KeluarBulanan"><i class="fa fa-table"></i>&nbsp;Pilih Periode</button>

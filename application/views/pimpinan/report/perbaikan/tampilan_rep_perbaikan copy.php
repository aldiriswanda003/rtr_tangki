                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <a href="<?= base_url('report_pimpinan/cetak_rep_perbaikan'); ?>"  style="margin-bottom:10px;" type="button" class="btn btn-sm btn-success" name="cetak_data"><i class="fa fa-print mr-2" aria-hidden="true"></i>Cetak</a>
                            ...
                            <form action="<?= site_url(); ?>report/cetak_rep_perbaikan" method="post" role="form" target="_blank">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?= site_url('report/tabel_rep_perbaikan'); ?>" method="get" role="form">

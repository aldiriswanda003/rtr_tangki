...
<body class="A4">
    <section class="sheet padding-10mm">
        ...
        <h4 style="margin-bottom: 5px;">DATA SUPIR RTR</h4>
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle;">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row">
                                    :&nbsp;<img src="<?= base_url('assets/upload/supir/foto_supir/' . $d->foto_supir); ?>" class="img img-box" width="100px" alt="<?= $d->nama_supir; ?>">
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle;">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row">
                                    :&nbsp;<img src="<?= base_url('assets/upload/supir/foto_sim/' . $d->foto_sim); ?>" class="img img-box" width="270px" alt="<?= $d->nama_supir; ?>"> </div>
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle;">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="row">
                                    :&nbsp;<img src="<?= base_url('assets/upload/supir/foto_ktp/' . $d->foto_ktp); ?>" class="img img-box" width="270px" alt="<?= $d->nama_supir; ?>"> </div>

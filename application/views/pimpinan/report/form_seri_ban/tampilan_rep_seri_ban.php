...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0">REPORT NOMOR SERI BAN</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <!-- <a href="<?= base_url('pimpinan/tambah_seri_ban'); ?>" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-primary" name="tambah_seri"><i class="fa fa-plus mr-2" aria-hidden="true"></i>Tambah</a> -->
                            <a href="<?= base_url('report_pimpinan/cetak_seri_ban'); ?>" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-success" name="tambah_data"><i class="fa fa-print mr-2" aria-hidden="true"></i>Cetak</a>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?= site_url('report_pimpinan/cetak_seri_ban'); ?>" method="get" role="form">

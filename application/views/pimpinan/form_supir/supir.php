                                    ...
                                    if (is_array($supir)) { ?>
                                        <?php foreach ($supir as $sp) : ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('pimpinan/edit_supir/' . $sp->id_supir); ?>" type="button" class="btn btn-sm btn-success" name="btn_edit" title="EDIT"><i class="fa fa-edit"></i></a><br><br>
                                                <a href="<?= base_url('pimpinan/hapus_data/' . $sp->id_supir); ?>" type="button" class="btn btn-sm btn-danger btn-delete" name="btn_delete" title="HAPUS"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php } ?>
                                </tbody>

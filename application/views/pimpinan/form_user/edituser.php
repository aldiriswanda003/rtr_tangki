            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('pimpinan/users'); ?>">Data User</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="width: 30%; margin-left: 35%;">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('pimpinan/proses_edituser'); ?>" method="post" level="form">
                                ...
                                <div class="form-group" align="center">
                                    <a href="<?= base_url('pimpinan/users'); ?>" type="button" class="btn btn-sm btn-danger" onclick="" name="btn_kembali"><i class="fa fa-arrow-left mr-2"></i>Batal</a>
